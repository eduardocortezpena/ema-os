# CONTEXTO_PROYECTOS.md — Histórico

Copia ciega del detalle narrativo (Qué es / Personas / notas largas) rotado
desde `.claude/docs/CONTEXTO_PROYECTOS.md` al superar el tope de 100 líneas.
El archivo activo conserva alias + señas distintivas + tabla rápida.
